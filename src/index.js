...
function selectableWordClickEvent(event) {
  ...
  if (node.parentNode == romaNode) {
    ...
    romaChildren[pos].dataset.id = node.dataset.id;
    romaChildren[pos].dataset.pos = node.dataset.pos;
